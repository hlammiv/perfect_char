...
g.append(0*b**1)
g.append(+0.*b**0+0.33333333333333337*b**1+0.013888888888888888*b**2)
g.append(+0.*b**0+0.33333333333333337*b**1+0.013888888888888888*b**2)
g.append(+0.*b**0+0*b**1+-0.08333333333333333*b**2)
g.append(+0.*b**0+0*b**1+0.013888888888888888*b**2)
g.append(+0.*b**0+0*b**1+0.013888888888888888*b**2)
